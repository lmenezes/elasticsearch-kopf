  ...
  $scope.loadAliases = function() {
    ElasticService.client.fetchAliases(
      function(index_aliases) {
        $scope.original = index_aliases.map(function(ia) {
          return ia.clone();
        });
...
kopf.factory('ExternalSettingsService', function($http, $q) {
  ...
  this.getElasticsearchRootPath = function() {
    return this.getSettings().elasticsearch_root_path;
  };
